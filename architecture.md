...
flowchart LR
  ...
  subgraph Frontend ["React SPA"]
    direction TB
    CLI["User’s Browser<br/>(React Components)"]
  end
  ...
  subgraph Controllers ["REST Controllers"]
    ...
    C6["TagController<br/>/api/tags &<br/>/api/posts/{id}/tags"]
